...
class Party(ModelSQL, ModelView):
    ...
    is_institution = fields.Boolean(
        'Center', help='Check if the party is a Health Care Center')
...
class PageOfLife(ModelSQL, ModelView):
    ...
    institution = fields.Many2One('gnuhealth.institution', 'Center')
...
class HealthInstitution(ModelSQL, ModelView):
    ...
    name = fields.Many2One(
        ...
        help='Party Associated to this Health Center',
        required=True,
    ...
    def __setup__(cls):
        ...
        t = cls.__table__()
        cls._sql_constraints = [
            ('name_uniq', Unique(t,t.name), 'This Center already exists !'),
...
class HealthInstitutionSpecialties(ModelSQL, ModelView):
    ...
    name = fields.Many2One('gnuhealth.institution', 'Center',
        required=True)
...
class HealthInstitutionOperationalSector(ModelSQL, ModelView):
    ...
    name = fields.Many2One('gnuhealth.institution', 'C',
        required=True)
...
class HealthInstitutionO2M(ModelSQL, ModelView):
    ...
    specialties = fields.One2Many('gnuhealth.institution.specialties',
        'name','Specialties',
        help="Specialties Provided in this Health Center")
...
class HospitalBuilding(ModelSQL, ModelView):
    ...
    institution = fields.Many2One(
        ...
        help='Health Center of this building')
