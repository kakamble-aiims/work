...
class InvestmentDeclaration(ModelSQL, ModelView):
    ...
    net_tax_exempted = fields.Float(
        'Total Tax Exempted', help="Under Chapter VI-A of IT Act"
    )
...
class InvestmentDeclarationLine(ModelSQL, ModelView):
    ...
    scheme = fields.Many2One(
        'investment.scheme', 'Scheme', help='Select Scheme'
    )
    section = fields.Many2One(
        'investment.section', 'Section', help='Select Section'
    )
    actual_amount = fields.Float(
        'Actual Amount', help='Enter invested amount'
    )
    remarks = fields.Char('Remarks', help='Enter remarks if any')
...
class IncomeDeclaration(ModelSQL, ModelView):
    ...
    tds = fields.Float('TDS Deducted', help="Tax Deducted from the source")
