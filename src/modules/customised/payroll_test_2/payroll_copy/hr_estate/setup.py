...
setup(name=name,
    ...
    package_dir={'trytond.modules.hr_estate': '.'},
    packages=[
        'trytond.modules.hr_estate',
        'trytond.modules.hr_estate.tests',
        ],
    package_data={
        'trytond.modules.hr_estate': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    hr_estate = trytond.modules.hr_estate 
    """,
    test_suite='tests',
