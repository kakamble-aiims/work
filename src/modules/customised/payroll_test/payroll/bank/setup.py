...
banks_require = [get_require_version('proteus')]
dependency_links = []
if minor_version % 2:
...
setup(name=name,
    version=version,
    description='Tryton module to bank of employees ',
    author='AIIMS CF',
    ...
    """,
    #bank_suite='banks',
    #bank_loader='trytond.bank_loader:Loader',
    #banks_require=banks_require,
    )
'''
setup.py
Displaying setup.py.
